    ...
    <div class="columns is-centered">
      <div class="column is-half">
        <div class="container post-container content">
          <h1
            class="title has-text-weight-bold has-text-centered has-text-primary"
            itemprop="headline"
          >
            {{ post.title }}
          </h1>
          ...
          <p class="has-text-centered post-date">
            Updated on
            <time
              :datetime="post.updated_at | HTMLDate"
    ...
    return {
      ...
      meta: [
        ...
        },
        {
          ...
          name: 'twitter:title',
          content:
            this.post.twitter_title || this.post.meta_title || this.post.title
        },
        {
